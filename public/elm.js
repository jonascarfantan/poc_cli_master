...
var $author$project$Style$colors = {
	black_cell: A3($mdgriffith$elm_ui$Element$rgb255, 80, 80, 80),
	highligth: A3($mdgriffith$elm_ui$Element$rgb255, 220, 220, 220),
	mauve: A3($mdgriffith$elm_ui$Element$rgb255, 130, 95, 160),
	oldgrey: A3($mdgriffith$elm_ui$Element$rgb255, 160, 160, 160),
	primary: A3($mdgriffith$elm_ui$Element$rgb255, 130, 95, 250),
	secondary: A3($mdgriffith$elm_ui$Element$rgb255, 84, 19, 160),
	white_cell: A3($mdgriffith$elm_ui$Element$rgb255, 220, 220, 220)
};
...
var $author$project$Game$Cell$allCells = _List_fromArray(
	[
		_List_fromArray(
		[
			_Utils_Tuple2('a', 1),
...
var $author$project$Game$Board$cell_string_to_el = function (_v0) {
	var rank = _v0.a;
	var file = _v0.b;
	var y = $elm$core$String$fromInt(file);
	var x = rank;
...
var $author$project$Game$Cell$whiteCells = _List_fromArray(
	[
		_Utils_Tuple2('a', 2),
		_Utils_Tuple2('a', 4),
		_Utils_Tuple2('a', 6),
...
var $author$project$Game$Board$renderCell = function (_v0) {
	var rank = _v0.a;
	var file = _v0.b;
	var _v1 = A2(
		$elm$core$List$member,
		_Utils_Tuple2(rank, file),
		$author$project$Game$Cell$whiteCells) ? _Utils_Tuple2($author$project$Style$colors.black_cell, $author$project$Style$colors.white_cell) : _Utils_Tuple2($author$project$Style$colors.white_cell, $author$project$Style$colors.black_cell);
	var font = _v1.a;
	var bg = _v1.b;
	return A2(
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Element$Font$color(font),
		...
		$mdgriffith$elm_ui$Element$text(
			$author$project$Game$Board$cell_string_to_el(
				_Utils_Tuple2(rank, file))));
};
...
var $author$project$Game$Board$boardRow = function (x) {
	return A2(
		...
		A2(
			$elm$core$List$map,
			function (y) {
				return $author$project$Game$Board$renderCell(y);
			},
			x));
};
var $author$project$Game$Board$createBoard = A2(
	$elm$core$List$map,
	function (x) {
		return $author$project$Game$Board$boardRow(x);
	},
	$author$project$Game$Cell$allCells);
var $author$project$Ui$board = function (m) {
	return A2(
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
				$mdgriffith$elm_ui$Element$Background$color($author$project$Style$colors.highligth)
			]),
		$author$project$Game$Board$createBoard);
};
var $author$project$Ui$board_wrap = function (m) {
	return $author$project$Ui$board(m);
};
var $author$project$Ui$game_arena = function (m) {
	return $author$project$Ui$board_wrap(m);
};
var $author$project$Ui$game_arena_wrap = function (m) {
	return A2(
		$mdgriffith$elm_ui$Element$row,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				$author$project$Ui$game_arena(m)
			]));
};
var $author$project$Ui$game_foot = function (m) {
	return A2(
		$mdgriffith$elm_ui$Element$el,
		_List_Nil,
		$mdgriffith$elm_ui$Element$text('ATH'));
};
var $author$project$Ui$game_foot_wrap = function (m) {
	return A2(
		$mdgriffith$elm_ui$Element$row,
		_List_fromArray(
			[
...
var $author$project$Shared$time_str = function (model) {
...
var $author$project$Ui$game_head = function (m) {
	return A2(
		$mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
		...
		$mdgriffith$elm_ui$Element$text(
			$author$project$Shared$time_str(m)));
};
var $author$project$Ui$game_head_wrap = function (m) {
	return A2(
		$mdgriffith$elm_ui$Element$row,
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Element$height(
				$mdgriffith$elm_ui$Element$fillPortion(1)),
				$mdgriffith$elm_ui$Element$Background$color($author$project$Style$colors.oldgrey),
				$mdgriffith$elm_ui$Element$alignRight
			]),
		_List_fromArray(
			[
				$author$project$Ui$game_head(m)
			]));
};
var $author$project$Ui$game_wrap = function (m) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Element$fillPortion(10)),
				$mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$fill),
				$mdgriffith$elm_ui$Element$Background$color($author$project$Style$colors.secondary),
				$mdgriffith$elm_ui$Element$padding(10)
			]),
		_List_fromArray(
			[
				$author$project$Ui$game_head_wrap(m),
				$author$project$Ui$game_arena_wrap(m),
				$author$project$Ui$game_foot_wrap(m)
			]));
};
var $author$project$Style$block_padding = $mdgriffith$elm_ui$Element$padding(10);
var $mdgriffith$elm_ui$Internal$Model$AlignY = function (a) {
	return {$: 'AlignY', a: a};
};
var $mdgriffith$elm_ui$Internal$Model$Top = {$: 'Top'};
var $mdgriffith$elm_ui$Element$alignTop = $mdgriffith$elm_ui$Internal$Model$AlignY($mdgriffith$elm_ui$Internal$Model$Top);
var $author$project$Ui$settings_body = function (m) {
	return A2(
		$mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
		...
		$mdgriffith$elm_ui$Element$text('Lot of Settings'));
};
var $author$project$Ui$settings_body_wrap = function (m) {
	return A2(
		$mdgriffith$elm_ui$Element$row,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				$author$project$Ui$settings_body(m)
			]));
};
var $mdgriffith$elm_ui$Internal$Model$Bottom = {$: 'Bottom'};
var $mdgriffith$elm_ui$Element$alignBottom = $mdgriffith$elm_ui$Internal$Model$AlignY($mdgriffith$elm_ui$Internal$Model$Bottom);
var $author$project$Ui$settings_foot = function (m) {
	return A2(
		$mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
...
var $author$project$Ui$settings_foot_wrap = function (m) {
	return A2(
		$mdgriffith$elm_ui$Element$row,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				$author$project$Ui$settings_foot(m)
			]));
};
var $author$project$Ui$settings_head = function (m) {
	return A2(
		$mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
		...
		$mdgriffith$elm_ui$Element$text('Cli_Master'));
};
var $author$project$Ui$settings_head_wrap = function (m) {
	return A2(
		$mdgriffith$elm_ui$Element$row,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				$author$project$Ui$settings_head(m)
			]));
};
var $author$project$Ui$settings_menu = function (m) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
				$mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$fill),
				$mdgriffith$elm_ui$Element$Background$color($author$project$Style$colors.mauve)
			]),
		_List_fromArray(
			[
				$author$project$Ui$settings_head_wrap(m),
				$author$project$Ui$settings_body_wrap(m),
				$author$project$Ui$settings_foot_wrap(m)
			]));
};
var $author$project$Ui$settings_menu_wrap = function (m) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$fill),
				$author$project$Style$block_padding,
				$mdgriffith$elm_ui$Element$Background$color($author$project$Style$colors.primary)
			]),
		_List_fromArray(
			[
				$author$project$Ui$settings_menu(m)
			]));
};
var $author$project$Ui$render = function (m) {
	return A2(
		$mdgriffith$elm_ui$Element$row,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				$author$project$Ui$settings_menu_wrap(m),
				$author$project$Ui$game_wrap(m)
			]));
};
var $author$project$Main$view = function (model) {
	return A2(
		...
		_List_Nil,
		$author$project$Ui$render(model));
};
var $author$project$Main$main = $elm$browser$Browser$element(
	{init: $author$project$Shared$init, subscriptions: $author$project$Main$subscriptions, update: $author$project$Main$update, view: $author$project$Main$view});
_Platform_export({'Main':{'init':$author$project$Main$main(
	A2(
		...
		A2($elm$json$Json$Decode$field, 'width', $elm$json$Json$Decode$int)))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{"Time.Era":{"args":[],"type":"{ start : Basics.Int, offset : Basics.Int }"}},"unions":{"Main.Msg":{"args":[],"tags":{"ToggleRunning":[],"Tick":["Time.Posix"],"AdjustTimeZone":["Time.Zone"]}},"Time.Posix":{"args":[],"tags":{"Posix":["Basics.Int"]}},"Time.Zone":{"args":[],"tags":{"Zone":["Basics.Int","List.List Time.Era"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"List.List":{"args":["a"],"tags":{}}}}})}});
